...
function startGame() {
  ...
  //Lyt efter op_ned-animationer er færdig
  document
    .querySelector("#blue_container1")
    .addEventListener("animationiteration", genstartBlue);
  //Lyt efter klik
  document
    .querySelector("#blue_container1")
    .addEventListener("mousedown", clickBlue);
}
...
function clickBlue() {
  ...
  document
    .querySelector("#blue_container1")
    .removeEventListener("mousedown", clickBlue);
  ...
  document
    .querySelector("#blue_container1")
    .addEventListener("animationend", genstartBlue);
...
function stopSpillet() {
  ...
  document
    .querySelector("#blue_container1")
    .removeEventListener("animationiteration", genstartBlue);
  document
    .querySelector("#blue_container1")
    .removeEventListener("animationend", genstartBlue);
  document
    .querySelector("#blue_container1")
    .removeEventListener("mousedown", clickBlue);
